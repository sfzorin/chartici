...
export const NODE_REGISTRY = {
  ...
  circle: {
    ...
    diagonalPorts: {
      S: [
        { exit: { dx:  40, dy: -40 }, anchor: { dx:  21.21, dy: -21.21 }, axis: 'H', sign:  1, dir: 'Right', penaltyId: 'DiagCircle' },
        { exit: { dx:  40, dy:  40 }, anchor: { dx:  21.21, dy:  21.21 }, axis: 'H', sign:  1, dir: 'Right', penaltyId: 'DiagCircle' },
        { exit: { dx: -40, dy: -40 }, anchor: { dx: -21.21, dy: -21.21 }, axis: 'H', sign: -1, dir: 'Left', penaltyId: 'DiagCircle' },
        { exit: { dx: -40, dy:  40 }, anchor: { dx: -21.21, dy:  21.21 }, axis: 'H', sign: -1, dir: 'Left', penaltyId: 'DiagCircle' },
      ],
      M: [
        { exit: { dx:  60, dy: -60 }, anchor: { dx:  28.28, dy: -28.28 }, axis: 'H', sign:  1, dir: 'Right', penaltyId: 'DiagCircle' },
        { exit: { dx:  60, dy:  60 }, anchor: { dx:  28.28, dy:  28.28 }, axis: 'H', sign:  1, dir: 'Right', penaltyId: 'DiagCircle' },
        { exit: { dx: -60, dy: -60 }, anchor: { dx: -28.28, dy: -28.28 }, axis: 'H', sign: -1, dir: 'Left', penaltyId: 'DiagCircle' },
        { exit: { dx: -60, dy:  60 }, anchor: { dx: -28.28, dy:  28.28 }, axis: 'H', sign: -1, dir: 'Left', penaltyId: 'DiagCircle' },
      ],
      L: [
        { exit: { dx:  80, dy: -80 }, anchor: { dx:  42.43, dy: -42.43 }, axis: 'H', sign:  1, dir: 'Right', penaltyId: 'DiagCircle' },
        { exit: { dx:  80, dy:  80 }, anchor: { dx:  42.43, dy:  42.43 }, axis: 'H', sign:  1, dir: 'Right', penaltyId: 'DiagCircle' },
        { exit: { dx: -80, dy: -80 }, anchor: { dx: -42.43, dy: -42.43 }, axis: 'H', sign: -1, dir: 'Left', penaltyId: 'DiagCircle' },
        { exit: { dx: -80, dy:  80 }, anchor: { dx: -42.43, dy:  42.43 }, axis: 'H', sign: -1, dir: 'Left', penaltyId: 'DiagCircle' },
      ],
    },
    outline:   OUTLINE.thick,
  ...
  rhombus: {
    ...
    diagonalPorts: {
      S: [
        { exit: { dx:  40, dy: -60 }, anchor: { dx:  20, dy: -20 }, axis: 'H', sign:  1, dir: 'Right', penaltyId: 'DiagRhombus' },
        { exit: { dx:  40, dy:  60 }, anchor: { dx:  20, dy:  20 }, axis: 'H', sign:  1, dir: 'Right', penaltyId: 'DiagRhombus' },
        { exit: { dx: -40, dy: -60 }, anchor: { dx: -20, dy: -20 }, axis: 'H', sign: -1, dir: 'Left', penaltyId: 'DiagRhombus' },
        { exit: { dx: -40, dy:  60 }, anchor: { dx: -20, dy:  20 }, axis: 'H', sign: -1, dir: 'Left', penaltyId: 'DiagRhombus' },
        { exit: { dx:  40, dy: -60 }, anchor: { dx:  20, dy: -20 }, axis: 'V', sign: -1, dir: 'Top', penaltyId: 'DiagRhombus' },
        { exit: { dx: -40, dy: -60 }, anchor: { dx: -20, dy: -20 }, axis: 'V', sign: -1, dir: 'Top', penaltyId: 'DiagRhombus' },
        { exit: { dx:  40, dy:  60 }, anchor: { dx:  20, dy:  20 }, axis: 'V', sign:  1, dir: 'Bottom', penaltyId: 'DiagRhombus' },
        { exit: { dx: -40, dy:  60 }, anchor: { dx: -20, dy:  20 }, axis: 'V', sign:  1, dir: 'Bottom', penaltyId: 'DiagRhombus' },
      ],
      M: [
        { exit: { dx:  60, dy: -60 }, anchor: { dx:  40, dy: -20 }, axis: 'H', sign:  1, dir: 'Right', penaltyId: 'DiagRhombus' },
        { exit: { dx:  60, dy:  60 }, anchor: { dx:  40, dy:  20 }, axis: 'H', sign:  1, dir: 'Right', penaltyId: 'DiagRhombus' },
        { exit: { dx: -60, dy: -60 }, anchor: { dx: -40, dy: -20 }, axis: 'H', sign: -1, dir: 'Left', penaltyId: 'DiagRhombus' },
        { exit: { dx: -60, dy:  60 }, anchor: { dx: -40, dy:  20 }, axis: 'H', sign: -1, dir: 'Left', penaltyId: 'DiagRhombus' },
        { exit: { dx:  40, dy: -60 }, anchor: { dx:  24, dy: -28 }, axis: 'V', sign: -1, dir: 'Top', penaltyId: 'DiagRhombus' },
        { exit: { dx: -40, dy: -60 }, anchor: { dx: -24, dy: -28 }, axis: 'V', sign: -1, dir: 'Top', penaltyId: 'DiagRhombus' },
        { exit: { dx:  40, dy:  60 }, anchor: { dx:  24, dy:  28 }, axis: 'V', sign:  1, dir: 'Bottom', penaltyId: 'DiagRhombus' },
        { exit: { dx: -40, dy:  60 }, anchor: { dx: -24, dy:  28 }, axis: 'V', sign:  1, dir: 'Bottom', penaltyId: 'DiagRhombus' },
      ],
      L: [
        { exit: { dx: 100, dy: -60 }, anchor: { dx:  80, dy: -20 }, axis: 'H', sign:  1, dir: 'Right', penaltyId: 'DiagRhombus' },
        { exit: { dx: 100, dy:  60 }, anchor: { dx:  80, dy:  20 }, axis: 'H', sign:  1, dir: 'Right', penaltyId: 'DiagRhombus' },
        { exit: { dx: -100, dy: -60 }, anchor: { dx: -80, dy: -20 }, axis: 'H', sign: -1, dir: 'Left', penaltyId: 'DiagRhombus' },
        { exit: { dx: -100, dy:  60 }, anchor: { dx: -80, dy:  20 }, axis: 'H', sign: -1, dir: 'Left', penaltyId: 'DiagRhombus' },
        { exit: { dx:  60, dy: -80 }, anchor: { dx:  40, dy: -40 }, axis: 'V', sign: -1, dir: 'Top', penaltyId: 'DiagRhombus' },
        { exit: { dx: -60, dy: -80 }, anchor: { dx: -40, dy: -40 }, axis: 'V', sign: -1, dir: 'Top', penaltyId: 'DiagRhombus' },
        { exit: { dx:  60, dy:  80 }, anchor: { dx:  40, dy:  40 }, axis: 'V', sign:  1, dir: 'Bottom', penaltyId: 'DiagRhombus' },
        { exit: { dx: -60, dy:  80 }, anchor: { dx: -40, dy:  40 }, axis: 'V', sign:  1, dir: 'Bottom', penaltyId: 'DiagRhombus' },
      ],
    },
    outline:   OUTLINE.thick,
