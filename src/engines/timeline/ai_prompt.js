...
Follow these rules:
1. Ensure every single element has a unique, simple alphanumeric ID (e.g. node_1, server_a).
2. "Size" defines the hierarchy level. You MUST use one of these EXACT words:
