...
export default {
    ...
    schema: {
        ...
        engineManifest: {
            layout: 'sequence',
            edgeStyle: 'deterministic_sequence',
            ...
            overlay: {
                ...
                lane: {
                    fillOpacity: 0.055,
                    stroke: { width: 1.6, dash: 'none', rx: 6, opacity: 0.5 },
                    divider: { width: 1.2, opacity: 0.4 },
                },
                label: { fontSize: 14, fontWeight: 720, opacity: 0.95 },
            },
        },
    },
    ...
    layout: {
        ...
        rules: {
            ...
            SEQUENCE_MIN_STEP_GAP: 60,
            SEQUENCE_CROSS_LANE_GAP: 60,
